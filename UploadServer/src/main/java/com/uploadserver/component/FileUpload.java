package com.uploadserver.component;
...
public class FileUpload {
    ...
    public FileInfo saveFile(MultipartFile multipartFile) throws IOException {
        ...
        // 绝对路径
        String absolutePath = fileDirectory + filePath + fileName + fileExtensions;
        // 相对路径
        String relativePath = filePath + fileName + fileExtensions;
        // 存放位置
        ...
        fileInfo.setFileName(fileName + fileExtensions);
